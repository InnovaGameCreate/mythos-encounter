...
namespace Scenes.Ingame.Player
{
    public class TempPlayerMove : MonoBehaviour
    {
        ...
        [Tooltip("スタミナの回復量(per 1sec)")][SerializeField] private int _recoverStamina = 20;
        [Tooltip("スタミナの回復量[疲労時](per 1sec)")][SerializeField] private int _recoverStaminaOnlyTired = 60;
        [Tooltip("スタミナの消費量(per 1sec)")][SerializeField] private int _expandStamina = 20;
        ...
        private IEnumerator IncreaseStamina()
        {
            ...
            {
                yield return new WaitForSeconds(0.5f);//回復開始までのラグ
        ...
        { 
            ...
            yield return new WaitUntil(() => _myPlayerStatus.nowStaminaValue　> 10);//スタミナが10になるまで回復するのを待つ
